...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Quiz>(entity =>
            {
                ...
                entity.HasOne(d => d.Linguagem)
                    .WithMany(p => p.Quiz)
                    .HasForeignKey(d => d.LinguagemId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Quiz_Linguagem");
            });
            ...
            modelBuilder.Entity<Resultados>(entity =>
            {
                ...
                entity.Property(e => e.RespostaDada).ValueGeneratedNever();
                ...
                entity.HasOne(d => d.Pergunta)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Resultados_QuizPergunta1");
            });
